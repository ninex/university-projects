...
//the frame split indices
typedef struct framers{
	int begin,end;
	framers *next;
}framers;
...
EXTERN ptrFrame *current;

EXTERN framers *frames,*first;

EXTERN int framecount,spl,last;

EXTERN double r_glob,g_glob,b_glob,rs,gs,bs,points,rm,gm,bm;
