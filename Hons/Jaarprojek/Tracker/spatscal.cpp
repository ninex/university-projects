...
static void Make_Spatial_Prediction_Frame(int progressive_frame,
  int llprogressive_frame,unsigned char*fld0,unsigned char*fld1,short *tmp,unsigned char *dst, int llx0,int lly0,int llw,int llh,int horizontal_size,int vertical_size,int vm,int vn,int hm,int hn,int aperture)
{
...
/* vertical resampling */
static void Subsample_Vertical(unsigned char*s,short *d,int lx,int lys,int lyd,int m,int n,int j0,int dj)
{
  int i, j, c1, c2, jd;
  unsigned char *s1, *s2;
  short *d1;
...
static void Subsample_Horizontal(short*s,unsigned char*d,int x0,int lx,int lxs,int lxd,int ly,int m,int n)
{
