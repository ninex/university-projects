...
**
** Created: Wed Aug 16 16:10:24 2006
...
QMetaObject* MyWidget::staticMetaObject()
{
    ...
    static const QUMethod slot_1 = {"hotspots", 0, 0 };
    static const QMetaData slot_tbl[] = {
	{ "play()", &slot_0, QMetaData::Protected },
	{ "hotspots()", &slot_1, QMetaData::Protected }
    };
