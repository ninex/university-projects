...
public class blueFringe{
	String train,output,imgName;
	boolean debug_out;
	int items,depth,imgNum = 0,statenum;
	double[] counts;
	//HashMap hash;
	...
	public blueFringe(String train,String output,String imgName, boolean debug_out){
		this.train = train;
		this.output = output;
...
//		Static functions
//=============================================================
	public static blueFringe parseParameters(String[] flags) {
		...
		return new blueFringe(train,output,img,d);
	}


	public static void main(String[] args){
		blueFringe dfa = parseParameters(args);
		
		if (dfa == null){
			System.out.println("\nUsage blueFringe [options]");
