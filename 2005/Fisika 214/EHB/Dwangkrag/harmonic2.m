...
[x_e, v_e, KE_e, PE_e, E_e] = Euler(m, k, c, F0, omega_d, x0, v0, t, dt);
[x_ec, v_ec, KE_ec, PE_ec, E_ec] = Euler_Cromer(m, k, x0, v0, t, dt);
[x_rk2, v_rk2, KE_rk2, PE_rk2, E_rk2] = RK2(m, k, x0, v0, t, dt);
[x_rk4, v_rk4, KE_rk4, PE_rk4, E_rk4] = RK4(m, k, c, F0, omega_d,x0, v0, t, dt);
...
title(['Snelheid met waardes m = ',num2str(m),' k = ',num2str(k),' x0 = ',num2str(x0),' v0 = ',num2str(v0),' dt = ',num2str(dt),' siklusse = ',num2str(aantal_siklusse) ]);
xlabel('t');
ylabel('v');
...
subplot(2,2,1);
plot(t,f_e,'r');
title(['Snelheid fout met waardes m = ',num2str(m),' k = ',num2str(k),' x0 = ',num2str(x0),' v0 = ',num2str(v0),' dt = ',num2str(dt),' siklusse = ',num2str(aantal_siklusse) ]);
xlabel('t');
ylabel('fout');
legend('Euler');
...
title(['Verplasing teenoor snelheid met waardes m = ',num2str(m),' k = ',num2str(k),' x0 = ',num2str(x0),' v0 = ',num2str(v0),' dt = ',num2str(dt),' siklusse = ',num2str(aantal_siklusse) ]);
xlabel('v');
ylabel('x');
legend('Analities','Euler');
